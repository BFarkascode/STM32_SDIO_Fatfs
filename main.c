 ...
 *  Change history: N/A
  ...
  ******************************************************************************
  ******************************************************************************
  * This is a simple FatFs test code to showcase the SDIO peripheral driving an SDcard.
  *
  */
...
uint8_t CMDREND_flag = 1;																//global flag flipped by the SDIO IRQ
uint8_t DATAREND_flag = 1;																//global flag flipped by the SDIO IRQ
...
//  SystemClock_Config();
  ...
  while (1)
  {
	  ...
	  if(gen_file_no == 5){																//we use file_no to always limit the number of files generated to 5
		 ...
		 gen_file_no++;																	//and increase the file counter
